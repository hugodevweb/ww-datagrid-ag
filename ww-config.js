...
hideInSimplifiedMode(config, [
  ...
  "enableFilterBuilder", "defaultAdvancedFilters",
  // Column behaviour / reordering
  "movableColumns", "resizableColumns", "allowColumnHiding",
  "rowReorder", "reorderInfoBox",
  // Pagination fine-tuning (the plain `pagination` toggle stays visible)
  "hasPaginationSelector", "paginationPageSize", "paginationPageSizeSelector",
  // Selection extras (rowSelection + enableClickSelection stay visible)
  "selectAll", "disableCheckboxes", "focusedRowId",
  // Editing knobs (editing still works via per-column config + sane defaults)
  "invalidEditValueMode", "cellEditMode",
  // Navigation column override + conditional row styling
  "navigationMessageCountFormula", "conditionalRowStyles",
  // Performance internals
  "rowBuffer", "rowHeight",
  // View-state persistence variables
  "viewEditedVariableId", "columnChooserVariableId", "calendarStateVariableId",
...
hideInSimplifiedMode(config, [
  ...
  // Action button
  "actionColor", "actionBackgroundColor", "actionPadding", "actionBorder",
  "actionBorderRadius", "actionFont", "actionFontSize", "actionFontFamily",
  "actionFontWeight", "actionFontStyle", "actionLineHeight",
  // Navigation column
  "navigationButtonBackground", "navigationButtonHoverBackground",
  ...
  "recordPillAccentWidth", "recordPillHoverShadow",
  // Column chooser panel
  "columnChooserBackground", "columnChooserBorderColor", "columnChooserBorderRadius",
  "columnChooserTextColor", "columnChooserAccentColor",
  // Group containers
  "groupBorderColor", "groupBorderRadius",
]);
/* wwEditor:end */
