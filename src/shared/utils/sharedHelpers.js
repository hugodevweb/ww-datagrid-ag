...
export const translations = {
  en: {
    ...
    stylingTab: 'Styling',
    addRule: 'Add rule',
    noRulesYet: 'No rules yet. Add one to color rows based on their content.',
    ruleN: 'Rule {n}',
    ruleLabel: 'Rule name',
    conditions: 'Conditions',
    pickColumn: 'Select a column',
    value: 'Value',
    ...
    pickValuesPlaceholder: 'Pick values…',
  ...
  fr: {
    ...
    noRulesYet: 'Aucune règle. Ajoutez-en une pour colorer les lignes selon leur contenu.',
    ruleN: 'Règle {n}',
    ruleLabel: 'Nom de la règle',
    conditions: 'Conditions',
    ...
    backgroundColorLabel: 'Arrière-plan',
    ...
    op_notContains: 'Ne contient pas',
    ...
    op_isEmpty: 'Est vide',
    op_isNotEmpty: 'N’est pas vide',
    op_isTrue: 'Est vrai',
    op_isFalse: 'Est faux',
    op_isAnyOf: 'Est l’un de',
    op_isNoneOf: 'N’est aucun de',
    pickValuesPlaceholder: 'Choisir des valeurs…',
